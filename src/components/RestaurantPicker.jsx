...
const RestaurantPicker = () =>
{
    ...
    return (
        <div className="bg-[url('/assets/Saturn.jpg')] bg-no-repeat bg-cover bg-center m-0">
            <div className="h-[100vh] grid grid-rows-9">
                ...
                <div className="row-start-4 flex justify-center">
                    <div className={`text-white bg-black/60 w-[320px] h-[175px] border rounded-[5px] ml-[10px] shadow-[0px_0px_0.2em_0px_rgba(0,0,0)] shadow-white m-0 overflow-y-auto ${condition ? "hidden" : ""}`}>
                ...
                <div className="row-start-7">
                    <div className="text-white flex justify-center">
                        <input
                            className="w-[375px] h-[70px] placeholder:font-bold text-center bg-black/60 border rounded-[5px] shadow-[0px_0px_0.2em_0px_rgba(0,0,0)] shadow-white text-[20px]"
                            placeholder="Input 'Italian' 'Chinese' or 'American'"
                            type="text"
