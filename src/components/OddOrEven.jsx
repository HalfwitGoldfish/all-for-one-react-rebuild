...
const OddOrEven = () =>
{
    ...
    return (
        <div className="bg-[url('/assets/Europa.jpg')] bg-no-repeat bg-cover bg-center m-0">
            <div className="h-[100vh] grid grid-rows-9">
                ...
                <div className="row-start-4 flex justify-center">
                    <div className={`text-white bg-black/60 w-[277px] h-[100px] border rounded-[5px] ml-[10px] shadow-[0px_0px_0.2em_0px_rgba(0,0,0)] shadow-white m-0 overflow-y-auto ${condition ? "hidden" : ""}`}>
